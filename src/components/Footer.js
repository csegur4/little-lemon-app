            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="/location" className="hover:underline">Address: </a>
                            </li>
                            <li className="mb-4">
                                <a href="tel:{00000000}" className="hover:underline">Phone Number: </a>
                            </li>
                            <li className="mb-4">
                                <a href="mailto:info@littlelemon.com" className="hover:underline">mailto:info@littlelemon.com</a>
                            </li>
                        </ul>
                    </div>
                    <div>
