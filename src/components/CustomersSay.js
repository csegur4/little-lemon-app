        ...
        <div className='customers-say-section bg-[#edefee]'>
          <div className="container mx-auto">
            <div className="text-center">
                ...
                <SwiperSlide>
                        <blockquote
                            className="flex h-full flex-col justify-between bg-white p-12 rounded-2xl ml-2 mr-2">
                            <div>
                            <div className="flex gap-0.5 text-[#495e57]">
                                <svg
                                className="h-5 w-5"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                ...
                <SwiperSlide>
                        <blockquote
                            className="flex h-full flex-col justify-between bg-white p-12 ml-2 mr-2 rounded-2xl">
                            <div>
                            <div className="flex gap-0.5 text-[#495e57]">
                                <svg
                                className="h-5 w-5"
