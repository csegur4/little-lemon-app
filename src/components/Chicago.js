          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 gap-2 md:grid-cols-2 ">
                        <div className='md:py-28 md:pr-28 p-10 md:p-0'>
                            <h1 className="text-4xl font-bold mt-0 md:mb-5 text-[#000000]"> Little Lemon Restaurant</h1>
                        ...
                        <div className='pb-5 hidden md:block md:pb-0'>
                            <img className='mx-auto rounded-2xl' src={RestaurantChefB} alt="Delicius Dish in Little Lemon Restaurant" width={350}/>
                        </div>
                    </div>
          </div>
        </div>
